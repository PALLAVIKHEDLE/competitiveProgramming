...
var minDifficulty = function(jobDifficulty, d) {
  ...
  // initialize the cache that will have the key of starting index and number of days
  // the value will be the value of the max for the current job plus the minimum total of all days after
  const cache = {};
